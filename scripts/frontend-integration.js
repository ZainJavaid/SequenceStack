 ...
 * This file demonstrates how to integrate Sequencestack with a web frontend
 */

// For React/Vue/Angular applications
export class SequencestackClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SequencestackClient(provider, contractAddress);
